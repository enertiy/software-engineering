...
class EarlyStopping(DisposableContext):
    ...
    def __init__(self, param_vars, initial_metric=None, checkpoint_dir=None,
        ...
        Args:
            ...
            checkpoint_dir (str): The directory where to save the latest
            ...
            cleanup (bool): Whether or not to cleanup the latest directory
    ...
    def _enter(self):
        # open a temporary directory if the latest dir is not specified
